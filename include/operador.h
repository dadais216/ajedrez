...
struct normal:public operador{
    ...
    colort* crearColor(v);
    vector<pair<int,getterCondTrig*>> setUpPermaMemTriggersPerNormalHolder;//para que se pongan triggers permanentes de memoria que apunten a cada normalholder correspondiente
    v lastPos;
};
